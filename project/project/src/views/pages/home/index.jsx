      ...
      <>
        <div id="wrapper">
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            <div id="content">
              <Navbar />
              <Pagehead header="Students" buttonText={'Add Student'} onClick={this.openAddMd.bind(this)} />
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            ...
                            <button className="btn btn-danger" onClick={this.openDeleteMd.bind(this, student, index)}>Delete</button> &nbsp;
                            <Link to={"/update-student/" + index} className="btn btn-warning">Update</Link> &nbsp;
                          </td>
                        </tr>
                      )
                    }))}
